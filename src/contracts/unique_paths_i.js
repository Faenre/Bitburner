...
/**
 * @param {Array} inputData the info given for the coding contract
 * @param {Array<Array<int>>} memory An internal memoization reference. Do not pre-fill.
 */
export default function solve(data, memory=null) {
